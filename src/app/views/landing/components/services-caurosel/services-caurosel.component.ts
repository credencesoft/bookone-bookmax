...
export class ServicesCauroselComponent implements OnInit {
  public carouselTileItems: Array<any> = [
    {
      icon: './media-be/images/landing/services/services3.svg',
      text: `Specialised & Dedicated team for Property & Hotel On-boarding.`,
      title: 'Guest Booking'
    },
    {
      icon: './media-be/images/landing/services/services4.svg',
    ...
    {
      icon: './media-be/images/landing/services/services5.svg',
    ...
    {
      icon: './media-be/images/landing/services/services6.svg',
    ...
    {
      icon: './media-be/images/landing/services/services7.svg',
    ...
    {
      icon: './media-be/images/landing/services/services8.svg',
      text: `Manage Rooms
