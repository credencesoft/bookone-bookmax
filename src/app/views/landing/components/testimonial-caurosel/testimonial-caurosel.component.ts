...
export class TestimonialCauroselComponent implements OnInit {
  public carouselTileItems: Array<any> = [
    ...
    vitae dignissimos, sapiente est atque tenetur`,
      user_image: "./media-be/images/landing/faces/15.jpg",
      user_name: "Jhone Doe",
    ...
    },
    {
      testimonial: `Adipisci quas repellat sed. Quasi quaerat aut nam possimus
    vitae dignissimos, sapiente est atque tenetur`,
      user_image: "./media-be/images/landing/faces/3.jpg",
      user_name: "Smith DOe",
    ...
    },
    {
      testimonial: `Adipisci quas repellat sed. Quasi quaerat aut nam possimus
    vitae dignissimos, sapiente est atque tenetur`,
      user_image: "./media-be/images/landing/faces/5.jpg",
    ...
    },
    {
      testimonial: `Adipisci quas repellat sed. Quasi quaerat aut nam possimus
    vitae dignissimos, sapiente est atque tenetur`,
      user_image: "./media-be/images/landing/faces/12.jpg",
    ...
    },
    {
      testimonial: `Adipisci quas repellat sed. Quasi quaerat aut nam possimus
    vitae dignissimos, sapiente est atque tenetur`,
      user_image: "./media-be/images/landing/faces/13.jpg",
