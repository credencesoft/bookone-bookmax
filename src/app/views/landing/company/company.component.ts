...
export class CompanyComponent implements OnInit {
  ...
  constructor( private meta:Meta) {
    ...
    this.meta.updateTag({property: 'og:image', content: 'https://bookonepms.com/media-be/images/landing/lOGO_d/logo_white.png'})
    ...
    this.meta.updateTag({name: 'twitter:image', content: 'https://bookonepms.com/media-be/images/landing/lOGO_d/logo_white.png'});
