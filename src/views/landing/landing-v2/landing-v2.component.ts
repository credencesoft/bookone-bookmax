...
@Component({
    ...
    standalone: true,
    imports: [NgClass, HeaderComponent, IntroNineComponent, FeaturesTwoComponent, ServicesCauroselComponent, Works1Component, BestComponent, LeftImageComponent, RightImageComponent, PricingOneComponent, TeamComponent, TestimonialCauroselComponent, FaqsComponent, ContactFormComponent, FooterComponent]
})
