...
@Component({
    ...
    standalone: true,
    imports: [NgClass, HeaderComponent, IntroTenComponent, FeaturesTwoComponent, ServicesCauroselComponent, Works1Component, BestComponent, LeftImageComponent, RightImageComponent, PricingOneComponent, TeamComponent, TestimonialCauroselComponent, FaqsComponent, ContactFormComponent, FooterComponent]
})
