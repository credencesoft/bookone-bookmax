...
@Component({
    ...
    standalone: true,
    imports: [NgClass, HeaderComponent, Intro2Component, FeaturesComponent, ServicesComponent, WorksCarouselComponent, BestComponent, LeftImageComponent, RightImageComponent, PricingOneComponent, TeamComponent, TestimonialComponent, FaqsComponent, ContactFormComponent, FooterComponent]
})
