...
@Component({
    ...
    standalone: true,
    imports: [NgClass, HeaderComponent, IntroFourComponent, FeaturesComponent, ServicesComponent, WorksCarouselComponent, BestComponent, LeftImageComponent, RightImageComponent, PricingOneComponent, TeamComponent, TestimonialComponent, FaqsComponent, ContactFormComponent, FooterComponent]
})
